...
export default function ResultsList({
    ...
    const hasMoreResults = visibleOrganizations.length < organizations.length;
    ...
    return (
        <div className="flex flex-col">
            ...
            {hasMoreResults && (
                <div
                    className="px-8 py-5 border-t text-[10px] font-black uppercase tracking-[0.18em]"
                    style={{ backgroundColor: '#f4f4f5', borderColor: '#59595B10', color: '#59595B90' }}
                >
                    Mostrando {visibleOrganizations.length} de {organizations.length} organizaciones
                </div>
            )}
        </div>
    );
